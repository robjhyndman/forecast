...
# Compute cross-validation and information criteria from a generalized additive model
CV <- function(obj)
{
  if(!is.element("gam", class(obj)))
    stop("This function is for objects of class gam")
